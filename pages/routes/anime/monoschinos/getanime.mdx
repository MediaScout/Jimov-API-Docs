...
<Tabs items={["JavaScript", "Python"]}>
  <Tab>
    ...
    fetch("https://jimov-api.vercel.app/anime/monoschinos/name/one-piece"); const data = await
...
This example shows how to make a GET request to the `/anime/monoschinos/name/one-iece` route to retrieve information about the anime "One Piece" from Monoschinos. The result is displayed in the console.
